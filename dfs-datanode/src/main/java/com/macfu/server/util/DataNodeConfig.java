...
public class DataNodeConfig {
    ...
    public static final String DATANODE_HOSTNAME = "dfs-data-02";
    public static final String DATANODE_IP = "192.168.31.111";
    public static final Integer NIO_PORT = 9301;
    public static final String DATA_DIR = "F:\\development\\tmp2";
}
